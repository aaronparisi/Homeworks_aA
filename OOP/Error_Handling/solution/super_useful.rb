...
def convert_to_int(str)
  begin
    ...
    num ||= 0
    # "num = 0 if num is not equal to anything already"
    # does this always run??  What's the point of that?
    # is there a reason we would not have an ArgumentError but also not assign num??
  end
