...
ActiveRecord::Schema.define(version: 2020_10_18_220505) do
  ...
  create_table "band_memberships", force: :cascade do |t|
    ...
    t.index ["member_id"], name: "index_band_memberships_on_member_id"
  end
  ...
  add_foreign_key "band_memberships", "users", column: "member_id"
