...
ActiveRecord::Schema.define(version: 2020_09_30_000203) do
  ...
  create_table "votes", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["shortened_url_id"], name: "index_votes_on_shortened_url_id"
  ...
  add_foreign_key "votes", "shortened_urls"
